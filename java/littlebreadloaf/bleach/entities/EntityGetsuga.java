...
public class EntityGetsuga extends Entity implements net.minecraft.entity.IProjectile
{
  private int xTile = -1;
  private int yTile = -1;
  private int zTile = -1;
      ...
      for (int ar5 = -1; ar5 <= 1; ar5++)
      {
        for (int ar6 = -1; ar6 <= 1; ar6++)
        {
          for (int ar7 = -2; ar7 <= 2; ar7++)
          {
            ...
            {
              littlebreadloaf.bleach.BleachMod.network.sendToAll(new ParticleMessage(0, ar8, ar9, ar10));
            }
