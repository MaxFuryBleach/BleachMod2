...
public class EntityShinigami extends EntityMob
{
  ...
  protected void dropFewItems(boolean par1, int par2)
  {
    ...
    {
      dropItem(BleachItems.zanpakuto, 1);
    }
    if (rand.nextInt(150 - par2) == 0)
    {
      dropItem(Armor.ShiniRobe, 1);
    }
    if (rand.nextInt(150 - par2) == 0)
    {
      dropItem(Armor.ShiniPants, 1);
    }
    if (rand.nextInt(150 - par2) == 0)
    {
      dropItem(Armor.Sandals, 1);
    }
  }
  ...
  public void onDeath(DamageSource par1DamageSource)
  {
    ...
    if ((par1DamageSource.getEntity() instanceof EntityPlayer))
    {
      ...
      ExtendedPlayer props = ExtendedPlayer.get(var7);
      ItemStack var9 = var7.inventory.armorInventory[3];
      Item var2; if ((var9 != null) && (var9.getItem() == Armor.HollowHelmet) && (rand.nextInt(20) == 0))
      {
        var2 = BleachItems.recordEscalon;
      }
