    ...
    for (int ar5 = -1; ar5 <= 1; ar5++)
    {
      for (int ar6 = -1; ar6 <= 1; ar6++)
      {
        for (int ar7 = -2; ar7 <= 0; ar7++)
        {
          ...
          if ((ar11 != null) && ((ar11 == Blocks.cactus) || (ar11 == Blocks.carrots) || (ar11 == Blocks.wheat) || (ar11 == Blocks.deadbush) || (ar11 == Blocks.cocoa) || (ar11 == Blocks.ice) || (ar11 == Blocks.leaves) || (ar11 == Blocks.leaves2) || (ar11 == Blocks.brown_mushroom_block) || (ar11 == Blocks.melon_stem) || (ar11 == Blocks.potatoes) || (ar11 == Blocks.pumpkin_stem) || (ar11 == Blocks.red_mushroom_block) || (ar11 == Blocks.reeds) || (ar11 == Blocks.snow_layer) || (ar11 == Blocks.vine) || (ar11 == Blocks.waterlily) || (ar11 == Blocks.web) || (ar11 == Blocks.brown_mushroom) || (ar11 == Blocks.yellow_flower) || (ar11 == Blocks.tallgrass) || (ar11 == Blocks.red_mushroom) || (ar11 == Blocks.red_flower)))
          {
            ...
            int ar12 = this.worldObj.getBlockMetadata(ar8, ar9, ar10);
    ...
    if (this.inGround)
    {
      ...
      if (var4 != null)
      {
        if (var4.entityHit != null)
        {
          ...
          if (!this.worldObj.isRemote)
            this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 1.0F, this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"));
          this.ticksInAir = 495;
          if (!this.worldObj.isRemote)
          {
            dropItem(BleachItems.seele, 1);
