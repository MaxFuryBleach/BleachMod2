...
public class EntityCero extends Entity implements IProjectile
{
  ...
  public EntityCero(World var1, EntityMenosGrande menos, float var3, boolean b)
  {
    super(var1);
    this.renderDistanceWeight = 10.0D;
    ...
    setLocationAndAngles(menos.posX, menos.posY + menos.getEyeHeight(), menos.posZ, menos.rotationYaw, -0.62831855F);
    ...
    if (this.inGround)
    {
      ...
      if ((var4 != null) && (this.ticksExisted > 2))
      {
        if (!this.worldObj.isRemote) {
          this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 2.0F, this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"));
        }
  ...
  public void onCollideWithPlayer(EntityPlayer var1)
  {
    if ((!this.worldObj.isRemote) && (this.inGround) && (this.arrowShake <= 0))
    {
      ...
      if ((this.canBePickedUp == 1) && (!var1.inventory.addItemStackToInventory(new ItemStack(littlebreadloaf.bleach.items.BleachItems.reiatsu, 1))))
      {
        var2 = false;
      }
