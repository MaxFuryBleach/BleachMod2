...
public class EntityHollowWasp extends EntityMob
{
  ...
  public boolean attackEntityAsMob(Entity par1Entity)
  {
    if (super.attackEntityAsMob(par1Entity))
    {
      ...
      {
        ExtendedPlayer props = (ExtendedPlayer)((EntityPlayer)par1Entity).getExtendedProperties("BleachPlayer");
        byte b0 = 0;
  ...
  public void onUpdate()
  {
    ...
    this.motionX += (Math.signum(d0) * 0.5D - this.motionX) * 0.07000000014901162D;
    this.motionY += (Math.signum(d1) * 0.699999988079071D - this.motionY) * 0.07000000014901162D;
    this.motionZ += (Math.signum(d2) * 0.5D - this.motionZ) * 0.07000000014901162D;
