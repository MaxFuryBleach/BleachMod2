...
public class EntityHollowGolem extends EntityMob
{
  ...
  float scale = getRenderSize() / 100.0F;
  ...
  protected void applyEntityAttributes()
  {
    ...
    if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL) || (this.worldObj.difficultySetting == EnumDifficulty.HARD))
    {
      ...
      getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(4.5D);
    }
    else {
  ...
  {
    boolean var2 = par1Entity.attackEntityFrom(DamageSource.causeMobDamage(this), 2.0F);
  ...
  public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
  {
    ...
    par1NBTTagCompound.setInteger("RenderSize", getRenderSize());
  }
  ...
  public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
  {
    ...
    setRenderSize(par1NBTTagCompound.getInteger("RenderSize"));
  }
}
