  ...
  protected void attackEntity(Entity par1Entity, float par2)
  {
    if ((par2 > 2.0F) && (par2 < 6.0F) && (rand.nextInt(10) == 0))
    {
      if (this.onGround)
      {
        ...
        this.motionX = (d0 / f2 * 0.5D * 0.800000011920929D + this.motionX * 0.40000000298023225D);
        this.motionZ = (d1 / f2 * 0.5D * 0.800000011920929D + this.motionZ * 0.40000000298023225D);
