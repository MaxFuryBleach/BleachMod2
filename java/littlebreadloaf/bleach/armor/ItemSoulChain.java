...
public class ItemSoulChain
  extends ItemArmor
{
  public ItemSoulChain(ItemArmor.ArmorMaterial par2, int par3, int par4)
  {
    super(par2, par3, par4);
    setUnlocalizedName("soulchain");
    setTextureName("bleach:soulchain");
  ...
  {
    this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "soulchain");
  }
  

  public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer)
  {
    return "bleach".toLowerCase() + ":textures/models/armor/soul_chain.png";
  }
