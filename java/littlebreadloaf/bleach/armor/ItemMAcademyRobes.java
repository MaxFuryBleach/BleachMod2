...
public class ItemMAcademyRobes
  extends ItemArmor
{
  public ItemMAcademyRobes(ItemArmor.ArmorMaterial par2, int par3, int armorType)
  {
  ...
  public void registerIcons(IIconRegister par1RegisterIcon)
  {
    ...
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "macademy_top");
    }
    
    if (this == Armor.MaleAcademyBottom)
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "macademy_bottom");
    }
  }
  ...
  public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer)
  {
    ...
    {
      return "bleach".toLowerCase() + ":textures/models/armor/male_academy_1.png";
    }
    if (stack.getItem() == Armor.MaleAcademyBottom)
    {
      return "bleach".toLowerCase() + ":textures/models/armor/male_academy_2.png";
    }
