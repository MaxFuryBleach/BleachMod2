...
{
  public ItemArrancarArmor(ItemArmor.ArmorMaterial par2, int par3, int par4)
  {
    super(par2, par3, par4);
    setCreativeTab(BleachItems.tabBleach);
    if (par4 == 1)
    {
      setTextureName("bleach:arrancar_top");
    }
    else if (par4 == 2)
    {
      setTextureName("bleach:arrancar_pants");
    }
    else if (par4 == 3)
    {
      setTextureName("bleach:arrancar_shoes");
    }
  }
  ...
  public void registerIcons(IIconRegister par1RegisterIcon)
  {
    if (this == Armor.ArrancarJacket)
    {
      ...
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "arrancar_top");
    }
    
    if (this == Armor.ArrancarPants)
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "arrancar_pants");
    }
    
    if (this == Armor.ArrancarShoes)
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "arrancar_shoes");
    }
  }
  ...
  public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer)
  {
    if ((stack.getItem() == Armor.ArrancarJacket) || (stack.getItem() == Armor.ArrancarShoes))
    {
      ...
      return "bleach".toLowerCase() + ":textures/models/armor/arrancar_armor_1.png";
    }
    if (stack.getItem() == Armor.ArrancarPants)
    {
      return "bleach".toLowerCase() + ":textures/models/armor/arrancar_armor_2.png";
    }
