...
public class ItemFAcademyRobes
  extends ItemArmor
{
  public ItemFAcademyRobes(ItemArmor.ArmorMaterial par2, int par3, int armorType)
  {
  ...
  public void registerIcons(IIconRegister par1RegisterIcon)
  {
    ...
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "facademy_top");
    }
    
    if (this == Armor.FemaleAcademyBottom)
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "facademy_bottom");
    }
  }
  ...
  public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer)
  {
    ...
    {
      return "bleach".toLowerCase() + ":textures/models/armor/female_academy_1.png";
    }
    if (stack.getItem() == Armor.FemaleAcademyBottom)
    {
      return "bleach".toLowerCase() + ":textures/models/armor/female_academy_2.png";
    }
