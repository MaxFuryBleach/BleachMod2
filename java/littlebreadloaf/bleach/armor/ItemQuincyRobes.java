...
{
  public ItemQuincyRobes(ItemArmor.ArmorMaterial par2, int par3, int par4)
  {
    super(par2, par3, par4);
    setCreativeTab(BleachItems.tabBleach);
    if (par4 == 1)
    {
      setTextureName("bleach:quincytop");
    }
    else if (par4 == 2)
    {
      setTextureName("bleach:quincyslacks");
    }
    else if (par4 == 3)
    {
      setTextureName("bleach:quincyshoes");
    }
  }
  ...
  public void registerIcons(IIconRegister par1RegisterIcon)
  {
    if (this == Armor.QuincyRobe)
    {
      ...
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "quincytop");
    }
    
    if (this == Armor.QuincyPants)
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "quincyslacks");
    }
    
    if (this == Armor.QuincyShoes)
    {
      this.itemIcon = par1RegisterIcon.registerIcon("bleach".toLowerCase() + ":" + "quincyshoes");
    }
  }
  ...
  public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer)
  {
    if ((stack.getItem() == Armor.QuincyRobe) || (stack.getItem() == Armor.QuincyShoes))
    {
      ...
      return "bleach".toLowerCase() + ":textures/models/armor/quincy_1.png";
    }
    if (stack.getItem() == Armor.QuincyPants)
    {
      return "bleach".toLowerCase() + ":textures/models/armor/quincy_2.png";
    }
