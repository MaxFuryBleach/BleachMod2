...
public class GuiZanpakuto extends GuiScreen
{
  ...
  public static final ResourceLocation texture = new ResourceLocation("bleach".toLowerCase(), "textures/guis/sword_gui.png");
  ...
  public void drawScreen(int x, int y, float f)
  {
    ...
    int var181 = 0;
    drawTexturedModalRect(var181 + 10, var233 + 18, 0, 0, 41, 152);
    super.drawScreen(x, y, f);
    
    this.mc.mcProfiler.endStartSection("Flame");
    boolean var11 = false;
    int var12 = var11 ? 16777215 : 15859712;
    String var34 = "" + props.getPoints(1);
    int var182 = 33;
    ...
    int var189 = (int)(var8.getStringWidth(var35) * 0.5D);
