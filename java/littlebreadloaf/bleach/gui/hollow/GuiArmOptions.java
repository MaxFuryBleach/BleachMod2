...
{
  ResourceLocation texture = new ResourceLocation("bleach".toLowerCase(), "textures/guis/arm_select_gui.png");
  ...
  public void actionPerformed(GuiButton button) { switch (button.id)
    ...
    case 3: 
      ...
      {
        BleachMod.network.sendToServer(new HollowPieceMessage(2, this.choice, 1));
