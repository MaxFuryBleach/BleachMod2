...
{
  ResourceLocation texture = new ResourceLocation("bleach".toLowerCase(), "textures/guis/back_select_gui.png");
  ...
  public void actionPerformed(GuiButton button) { switch (button.id)
    ...
    case 3: 
      ...
      {
        BleachMod.network.sendToServer(new HollowPieceMessage(1, this.choice, this.points));
