...
{
  ResourceLocation texture = new ResourceLocation("bleach".toLowerCase(), "textures/guis/head_select_gui.png");
  ...
  public void actionPerformed(GuiButton button) { switch (button.id)
    ...
    case 3: 
      ...
      {
        BleachMod.network.sendToServer(new HollowPieceMessage(0, this.choice, this.points));
        ExtendedPlayer.get(this.player).setHead(this.choice);
      }
