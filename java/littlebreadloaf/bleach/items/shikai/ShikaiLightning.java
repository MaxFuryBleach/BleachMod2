  ...
  extends ItemShikai
{
  ...
  public ShikaiLightning(Item.ToolMaterial material)
  {
    super(material);
  ...
  public void onPlayerStoppedUsing(ItemStack var1, World var2, EntityPlayer var3, int var4)
  {
    ...
    if (var7 > 1.0F)
    {
      ...
      for (int i = 0; i < 20; i++)
      {
        double xpos = var3.posX + this.rand.nextInt(15) - this.rand.nextInt(15);
        double zpos = var3.posZ + this.rand.nextInt(15) - this.rand.nextInt(15);
        if ((Math.abs(xpos - var3.posX) > 1.0D) && (Math.abs(zpos - var3.posZ) > 1.0D))
        {
