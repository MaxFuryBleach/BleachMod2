...
public class RenderEnergyArrow
  extends Render
{
  ...
  {
    bindEntityTexture(par1EntityEnergyArrow);
    GL11.glPushMatrix();
    ...
    float f10 = 0.05625F;
    GL11.glEnable(32826);
    float f11 = par1EntityEnergyArrow.arrowShake - par9;
  ...
  {
    return getArrowTextures((EntityEnergyArrow)par1Entity);
  }
  ...
  {
    renderEnergyArrow((EntityEnergyArrow)par1Entity, par2, par4, par6, par8, par9);
  }
}
