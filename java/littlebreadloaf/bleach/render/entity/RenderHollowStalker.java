...
public class RenderHollowStalker
  extends RenderLiving
{
  private static final ResourceLocation texture1 = new ResourceLocation("bleach".toLowerCase() + ":textures/models/mobs/hollow_stalker.png");
  private static final ResourceLocation texture2 = new ResourceLocation("bleach".toLowerCase() + ":textures/models/mobs/hollow_stalker2.png");
  private static final ResourceLocation texture3 = new ResourceLocation("bleach".toLowerCase() + ":textures/models/mobs/hollow_stalker3.png");
  ...
  {
    renderHollowStalker((EntityHollowStalker)par1, par2, par3, par4, par5, par6);
  }
