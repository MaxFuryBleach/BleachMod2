...
public class RenderGetsuga
  extends Render
{
  private static final ResourceLocation arrowTextures = new ResourceLocation("bleach".toLowerCase() + ":textures/items/getsugaarrows.png");
  
  public void renderGetsuga(EntityGetsuga par1EntityGetsuga, double par2, double par4, double par6, float par8, float par9)
  {
    bindEntityTexture(par1EntityGetsuga);
    GL11.glPushMatrix();
    ...
    float f10 = 0.05625F;
    GL11.glEnable(32826);
    float f11 = par1EntityGetsuga.arrowShake - par9;
  ...
  {
    return getArrowTextures((EntityGetsuga)par1Entity);
  }
  ...
  {
    renderGetsuga((EntityGetsuga)par1Entity, par2, par4, par6, par8, par9);
  }
}
