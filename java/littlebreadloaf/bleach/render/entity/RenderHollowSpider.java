...
public class RenderHollowSpider
  extends RenderLiving
{
  private static final ResourceLocation texture1 = new ResourceLocation("bleach".toLowerCase() + ":textures/models/mobs/hollow_spider.png");
  private static final ResourceLocation texture2 = new ResourceLocation("bleach".toLowerCase() + ":textures/models/mobs/hollow_spider2.png");
  private static final ResourceLocation texture3 = new ResourceLocation("bleach".toLowerCase() + ":textures/models/mobs/hollow_spider3.png");
  ...
  {
    renderHollowSpider((EntityHollowSpider)par1, par2, par3, par4, par5, par6);
  }
  ...
  {
    scaleSpider((EntityHollowSpider)par1EntityLivingBase, par2);
  }
